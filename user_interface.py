...
class UserInterface():
    ...
    def __init__(self) -> None:
        ...
        self.window.setGeometry(100, 100, 1450, 800)  #original=(100, 100, 1600, 1000)
        self.window.setFixedSize(1450, 800) #it was change to adjust to other screen original=(1600, 1000)
